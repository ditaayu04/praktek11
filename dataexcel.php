...
while ($row = mysqli_fetch_array($sql)) {
    ...
    $sheet->setCellValue('F'.$i,$row['no_ujian']);
...
$sql = mysqli_query($conn,"SELECT * FROM datadiri");
$i  = 5;
$no = 1;
while ($row = mysqli_fetch_array($sql)) {
    $sheet->setCellValue('M'.$i,$row['namalgkp']);
    ...
    $sheet->setCellValue('AB'.$i,$row['tempattgl']);
...
$sql = mysqli_query($conn,"SELECT * FROM dbayah");
$i  = 5;
$no = 1;
while ($row = mysqli_fetch_array($sql)) {
    $sheet->setCellValue('AK'.$i,$row['nama']);
    $sheet->setCellValue('AL'.$i,$row['tahun_lahir']);
    $sheet->setCellValue('AM'.$i,$row['pendidikan']);
    $sheet->setCellValue('AN'.$i,$row['pekerjaan']);
    $sheet->setCellValue('AO'.$i,$row['penghasilan']);
    $sheet->setCellValue('AP'.$i,$row['berkebutuhan']);
    $i++;
}
$sql = mysqli_query($conn,"SELECT * FROM dbibu");
$i  = 5;
$no = 1;
while ($row = mysqli_fetch_array($sql)) {
    $sheet->setCellValue('AQ'.$i,$row['namaibu']);
    $sheet->setCellValue('AR'.$i,$row['tahun_lahir']);
    $sheet->setCellValue('AS'.$i,$row['pendidikan']);
    $sheet->setCellValue('AT'.$i,$row['pekerjaan']);
    $sheet->setCellValue('AU'.$i,$row['penghasilan']);
    $sheet->setCellValue('AV'.$i,$row['berkebutuhan']);
    $i++;
}
